...
Ela aceita seis Query Strings obrigatórias:
...
O parâmetro **currentPage** define a página atual da paginação.

O parâmetro **perPage** define a quantidade de resultados por página da paginação.

Os parâmetros **sortBy** e **sortOrder** definem a ordenação dos resultados. sortBy é o campo e 1 para 
crescente ou -1 para decrescente.

O parâmetro **search** é usado para realizar uma busca nos seguintes campos: endereço, condomínio, 
...
Ela aceita uma Query String obrigatória:
