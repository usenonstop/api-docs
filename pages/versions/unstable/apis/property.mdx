...
O parâmetro **selected** é opcional e aceita uma lista de coordenadas no formato: `${lat},${lng}` como string. Essa informação é usada para retornar os imóveis selecionados no mapa.
